...
(function () {
    ...
    var FakeCaret = function (root, isBlock, hasFocus) {
      ...
      var getCss = function () {
        ...
        return '.mce-visual-caret {display:none}' + '.mce-visual-caret-hidden {display:none}' + '*[data-mce-caret] {' + 'position: absolute;' + 'left: -1000px;' + 'right: auto;' + 'top: 0;' + 'margin: 0;' + 'padding: 0;' + '}';
      };
      return {
        show: show,
        hide: hide,
