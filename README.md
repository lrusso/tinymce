...
Bugfix 7 | Skin LightGray | Fixes the max height possible for menus.
Bugfix 8 | Theme Modern | Prevents from changes in the viewport in mobile devices.
Bugfix 9 | TinyMCE Style | Prevents from showing extra large fonts in mobile devices.
Bugfix 10 | TinyMCE Core | Prevents from losing breaklines when copying and pasting a text.
