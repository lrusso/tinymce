...
Bugfix 6 | Skin LightGray | Fixes the max height possible for menus.
Bugfix 7 | Theme Modern | Prevents from changes in the viewport in mobile devices.
Bugfix 8 | TinyMCE Style | Prevents from showing extra large fonts in mobile devices.
Bugfix 9 | TinyMCE Core | Prevents from losing breaklines when copying and pasting a text.
